    ...
    public partial class InitDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderID = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "NEWID()"),
                    UserID = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SellerID = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AddressID = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaymentID = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "NEWID()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Orders_OrderID_UserID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Orders_OrderID1_OrderUserID",
                        columns: x => new { x.OrderID1, x.OrderUserID },
                        principalTable: "Orders",
                        principalColumns: new[] { "OrderID", "UserID" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrderID1_OrderUserID",
                table: "OrderItems",
                columns: new[] { "OrderID1", "OrderUserID" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_OrderID_UserID",
                table: "Payments",
